...
/**
 * Offset-based {@link Pageable} for the Employee module.
 *
 ...
 * (ArchUnit: controllers must not depend on {@code ..repository..}). It mirrors the
 * Interaction module's adapter — the two cannot share one because ArchUnit forbids
 * cross-module {@code repository} imports.
 */
