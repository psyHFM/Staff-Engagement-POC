...
- [ ] 11.7 Push the branch; open the PR with per-ticket checklist + "closes #ATSE1-25" … "closes #ATSE1-35" footers
- [ ] 11.8 Transition all 11 Jira tickets to Done via `mcp__plugin_atlassian_atlassian__transitionJiraIssue`
